...
public class MainServiceImpl implements MainService {
	...
	public String loginCheck(MemberDTO member) {
		...
		if (BCrypt.checkpw(member.getPassword(), password))
			return member.getId();
		else
			return "";
	}
	...
	public String createToken(MemberDTO member, Date expireDate) {
		...
		return Jwts.builder().claim("id", member.getId()).claim("name", member.getName())
				.claim("address", member.getAddress()).claim("tel", member.getTel()).claim("email", member.getEmail())
				.claim("nickname", member.getNickname()).claim("birthday", member.getBirthday())
				.claim("introduce", member.getIntroduce()).claim("regist_type", member.getRegist_type())
				.claim("dist_search", member.getDist_search()).claim("name_search", member.getName_search())
				.claim("manager", member.getManager()).claim("member_state", member.getMember_state())
