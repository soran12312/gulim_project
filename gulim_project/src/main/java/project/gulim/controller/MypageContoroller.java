...
//쪽지 보내기
	...
	public String save_message(@RequestParam("message_title") String message_title,
			@RequestParam("receive_id") String receive_id, @RequestParam("message_content") String message_content) {
		...
		try {
			...
			if (originFilename != null && !originFilename.equals("")) {
				...
				String savePath = System.getProperty("user.dir")
						+ "\\src\\main\\resources\\static\\files\\images\\mypage\\info_profile";
...
//나중에 최종때 변경
				// String filepath
				// ="https://192.168.0.68:8080/files/images/mypage/info_profile/" +filename;
