...
public class MainController {
	...
	public String login(MemberDTO id, HttpServletResponse res) {
		...
		long access_token_valid = jwt.getAccess_token_valid().getTime() - System.currentTimeMillis(); // 만료 날짜와 현재 시간의
																										// 차이를 계산
		...
		long refresh_token_valid = jwt.getRefresh_token_valid().getTime() - System.currentTimeMillis(); // 만료 날짜와 현재 시간의
																										// 차이를 계산
