...
<!-- ================START OF 좌측 마케팅 메세지==================== -->
		<div class="all_marketing_message_back"></div>
		<div class="all_marketing_message">
			<div class="marketing_messge1">
				준비는 “굴림”이 할게요.<br/>게임하기도 바쁘니까! <br/>
			</div>
			<div class="marketing_messge2">
				함께할 친구를 찾거나 게임을 준비하고 <br/> 시나리오를 우리 모임에 딱 맞게 설정하는 것,<br/>
				모두 다 “굴림”에게 맡겨주세요! <br/>모든것이 “굴림” 속에서!
			</div>
		</div>
...
<!-- ================START OF 로그인폼==================== -->
		...
		<form action="/main/loginCheck" method="post">
			<!-- ===== 로그인폼 상단 LOGIN 글자 ===== -->
			<div class="loginform_login">Login</div>
