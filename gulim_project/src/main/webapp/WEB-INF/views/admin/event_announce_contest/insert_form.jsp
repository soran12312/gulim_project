                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="media dropdown-item">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <p><strong>Jennifer</strong> purchased Light Dashboard 2.0.
                                                            </p>
                                                        </a>
                                                    </div>
                                                    <span class="notify-time">3:20 am</span>
                                                ...
                                                <li class="media dropdown-item">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <p><strong>Robin</strong> marked a <strong>ticket</strong>
                                                                as unsolved.
                                                            </p>
                                                        </a>
                                                    </div>
                                                ...
                                                <li class="media dropdown-item">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <p><strong> James.</strong> has added
                                                                a<strong>customer</strong> Successfully
                                                            </p>
                                                        </a>
                                                    </div>
                                                    <span class="notify-time">3:20 am</span>
                ...
                <div class="quixnav">
                    <div class="quixnav-scroll">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="/admin/question"><i class="icon icon-single-04"></i><span class="nav-text">회원
                                        관리</span></a>
                            </li>

                            <li><a href="/admin/place_list"><i class="icon icon-world-2"></i><span class="nav-text">모임장소
                                        관리</span></a>
                            </li>
                            <li><a href="/admin/sales_stats"><i class="icon icon-chart-bar-33"></i><span
                                        class="nav-text">판매 관리</span></a>
                            </li>
                            <!-- 현재 선택된 대카테고리 -->
                            ...
                            <li><a href="/admin/product_list"><i class="icon icon-plug"></i><span class="nav-text">상품 및
                                        서비스 관리</span></a>
                            </li>
                            <li><a href="/admin/game_stats"><i class="icon icon-app-store"></i><span class="nav-text">게임
                                        통계</span></a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div id="announceOrEvent">
                                        <table>
                                            <tr>
                                                <td colspan="2">
                                                    <div
                                                        style="position: relative; top:14px; right: -19px; width: 192px; float: left;">
                                                        <!-- 게시판 종류 선택 -->
                                                ...
                                                <td colspan="2">
                                                    <div class="card-body"
                                                        ...
                                                        <input name="datepicker" class="datepicker-default form-control"
                                                            id="datepicker" placeholder="시작일 선택">
                                                    </div>
                                                </td>
                                                <td colspan="2">
                                                    <div class="card-body" style="width: 230px;">
                                                        ...
                                                        <p class="mb-1">종료일</p>
                                                        <input name="datepicker" class="datepicker-default form-control"
                                                            id="datepicker" placeholder="종료일 선택">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="card-body"
                                                        ...
                                                        <!-- 공모전의 시작일 설정 -->
                                                        <p class="mb-1">시작일</p>
                                                        <input type="date" name="start_date" placeholder="시작일 선택">
                                                    </div>
                                                </td>
                                                <td colspan="2">
                                                    <div class="card-body" style="width: 230px;">
                                                        <!-- 공모전의 종료일 설정 -->
                                                        <p class="mb-1">종료일</p>
                                                        <input type="date" name="end_date" placeholder="종료일 선택">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
