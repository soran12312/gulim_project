        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-image" width="190" height="68" src="/files/images/LOGO_white_ver.png" alt="" style="position: relative; top: -2px; right: -14px;">
            </a>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./index.html">문의사항 답변</a></li>
                            <li><a href="./index2.html">제재 관리</a></li></ul>
                    </li>
                    
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-world-2"></i><span class="nav-text">모임장소 관리</span></a>
                        <ul aria-expanded="false">
                            <li><a href="./app-profile.html">모임장소 관리</a></li>
                    ...
                    <li><a href="widget-basic.html" aria-expanded="false"><i class="icon icon-app-store"></i><span
                                class="nav-text">게임 통계</span></a></li>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">Q&A list</span>
                        </div>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">회원 관리</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">문의사항 답변</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
